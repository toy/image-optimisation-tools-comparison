(function() {
  ...
  /**
   * @description
   * Read the named JSON file in directory and write it's contents to the named member of results.
   *
   * @inner
  ...
  /**
   * @description
   * Read the results of a previously run test whose results were written to the given directory.
   *
   * @param  {String} directory
   * @return {Promise}
   */
