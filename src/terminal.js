...
(function() {
  ...
  /**
   * @description
   * Returns a promise for a {String[]} containing the absolue file system paths to every
  ...
  /**
   * @description
   * Returns a promise for a {Number} showing the size in bytes of a location on the file system.
   *
   * @param  {String} location
   * @return {Promise}
   */
